...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="{{ url('/public/assets/css/material-dashboard.css?v=3.1.0')}}" rel="stylesheet" />
...
<body class="bg-gray-200">
  ...
  <script src="{{url('/public/assets/js/material-dashboard.min.js?v=3.1.0')}}"></script>
</body>
