            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        ...
                        <div class="mt-2">
                            <a href="{{ route('admin.plans.create') }}" class="btn btn-info btn float-end">Create Plans
                            </a>
                        </div>
                    </div>
                    @if (session('success'))
                                ...
                                <tbody>
                                    @foreach ($plans as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="mb-0 text-sm">{{ $item['validity']." " ."Months" }}</h6>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                ...
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('admin.plans.destroy', $item['id']) }}"
                                                    class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                                                    data-original-title="Reports">
                                                    <i class="fas fa-trash text-white text-sm" data-bs-toggle="tooltip"
                                                        data-bs-placement="top" aria-hidden="true" aria-label="Reports"
                                                        data-bs-original-title="Reports"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
