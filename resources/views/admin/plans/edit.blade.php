                                        ...
                                        <div class="col-12">
                                            <div class="form-group mt-2">
                                                ...
                                                <select name="validity" id="validity" class="form-control" style="background-color: #eeeeee; padding-left: 10px">
                                                    <option value="1" @if ($plan['validity'] == 1) selected @endif >1 Month</option>
                                                    <option value="3" @if ($plan['validity'] == 3) selected @endif>3 Months</option>
                                                    <option value="6" @if ($plan['validity'] == 6) selected @endif>6 Months</option>
                                                    <option value="12" @if ($plan['validity'] == 12) selected @endif>1 Year</option>
                                                    <option value="24" @if ($plan['validity'] == 24) selected @endif>2 Years</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
