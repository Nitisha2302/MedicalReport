                            ...
                            <form action="{{ route('admin.patient.update', $patient->id ) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body p-3">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="blood_group" id="user-name" class="form-control"
                                                    placeholder="Blood Group" value="{{ $patient->blood_group }}"
                                                    style="background-color: #eeeeee; padding-left: 10px">
                                            </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mt-2">
                                                ...
                                                <input type="text" name="phone" id="phone" class="form-control"
                                                    placeholder="Phone" value="{{ $patient->phone ?? '' }}"
                                                    style="background-color: #eeeeee; padding-left: 10px">
                                            </div>
                                            @error('phone')
                                                <div class="alert alert-danger alert-dismissible text-white" role="alert">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group mt-2">
                                                <label for="specialized" class="form-control-label">Doctor Name</label>
                                                <input type="text" name="specialized" id="specialized"
                                                    class="form-control" placeholder="specialized" value="{{ $patient->doctor->name  ?? ''}}"
                                                    style="background-color: #eeeeee; padding-left: 10px">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group mt-2">
                                                <label for="email-address" class="form-control-label">Height</label>
                                                <input type="text" name="height" id="email-address" class="form-control"
                                                    placeholder="Height" value="{{ $patient->height ?? ''}}"
                                                    style="background-color: #eeeeee; padding-left: 10px">
                                            </div>
                                            @error('height')
                                                <div class="alert alert-danger alert-dismissible text-white" role="alert">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mt-2">
                                                <label for="phone" class="form-control-label">Weight</label>
                                                <input type="text" name="weight" id="weight" class="form-control"
                                                    placeholder="Confirm Password" value="{{ $patient->weight ?? ''}}"
                                                    style="background-color: #eeeeee; padding-left: 10px">
                                            </div>
                                            @error('weight')
                                                <div class="alert alert-danger alert-dismissible text-white" role="alert">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mt-2">
                                                ...
                                                <textarea name="address" id="address" class="form-control" placeholder="specialized"
                                                    style="background-color: #eeeeee; padding-left: 10px"> {{ $patient->address ?? '' }}
                                                </textarea>
                                            </div>
